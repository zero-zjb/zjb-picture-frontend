...
export async function addSpaceUserUsingPost(body: API.Pinyin_11, options?: { [key: string]: any }) {
...
/** 编辑空间成员信息 POST /api/spaceUser/edit */
...
/** 查询空间成员信息 POST /api/spaceUser/get */
export async function getSpaceUserUsingPost(body: API.Pinyin_21, options?: { [key: string]: any }) {
