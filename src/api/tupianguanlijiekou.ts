...
export async function editPictureUsingPost(body: API.Pinyin_9, options?: { [key: string]: any }) {
...
export async function updatePictureUsingPost(body: API.Pinyin_7, options?: { [key: string]: any }) {
