...
export async function deleteSpaceUsingPost(body: API.Pinyin_27, options?: { [key: string]: any }) {
...
export async function editSpaceUsingPost(body: API.Pinyin_25, options?: { [key: string]: any }) {
