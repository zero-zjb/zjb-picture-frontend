...
export async function deleteSpaceUsingPost(body: API.Pinyin_17, options?: { [key: string]: any }) {
...
export async function editSpaceUsingPost(body: API.Pinyin_16, options?: { [key: string]: any }) {
